// public/js/cms/cmsTestimonials.js
document.addEventListener('DOMContentLoaded', function() {
  // Initialize testimonials management functionality
  ...
  if (statusFilter) {
    statusFilter.addEventListener('change', function() {
      ...
      window.location.href = `/admin/testimonials${status !== 'all' ? '?filter=' + status : ''}`;
    });
  }
  ...
  function performSearch() {
    ...
    window.location.href = `/admin/testimonials?${urlParams.toString()}`;
  }
  ...
  if (deleteButtons.length > 0) {
    ...
    if (modal && confirmButton && cancelButton && closeButton) {
      confirmButton.addEventListener('click', function() {
        ...
        // Send delete request
        fetch(`/admin/testimonials/${currentItemId}`, {
          method: 'DELETE',
          headers: {
  ...
  // Form enhancements for the testimonial form
